...
export const otpTemplate = ({ name, otp }: { name: string; otp: string }) => `
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8" />
	<meta name="viewport" content="width=device-width, initial-scale=1.0" />
	<title>Email Verification - CineTube</title>
</head>
<body style="margin:0;padding:40px 20px;background:#f4f4f4;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;color:#1a1a1a;">
	<div style="max-width:520px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;border:1px solid #e0e0e0;">
		<div style="padding:28px 40px 20px;text-align:center;border-bottom:1px solid #f0f0f0;">
			...
			<div style="margin-top:6px;font-size:11px;letter-spacing:3px;text-transform:uppercase;color:#999;">Email Verification</div>
		</div>

		<div style="padding:32px 40px;">
			<h2 style="font-size:18px;font-weight:500;margin:0 0 8px;">Hey ${escapeHtml(name)}, verify your email</h2>
			<p style="font-size:14px;color:#666;line-height:1.7;margin:0 0 28px;">
				Thanks for signing up on CineTube. Use the one-time password below to verify your email address and activate your account.
			</p>
			...
			<div style="background:#fafafa;border:1px solid #e8e8e8;border-radius:12px;text-align:center;padding:24px 20px;margin-bottom:24px;">
				<div style="font-size:11px;text-transform:uppercase;letter-spacing:2.5px;color:#aaa;font-weight:500;margin-bottom:16px;">One-time password</div>
